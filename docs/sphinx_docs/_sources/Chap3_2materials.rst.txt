...
- :ref:`Sec:input:StiffenedGas`: For condensed matter (liquid) in a pressure range where the compressible assumption is reasonable. 
- :ref:`Sec:input:NobleAbelStiffenedGas`: For condensed matter (liquid) subject to phase change.
