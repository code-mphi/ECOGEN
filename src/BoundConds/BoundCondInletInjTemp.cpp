...
BoundCondInletInjTemp::BoundCondInletInjTemp(int numPhysique, XMLElement* element, const int& numbPhases, std::string fileName) : BoundCond(numPhysique)
{
...
void BoundCondInletInjTemp::creerCellInterfaceChild()
{
  m_cellInterfacesChildren.push_back(new BoundCondInletInjTemp(*this, m_lvl + 1));
}
