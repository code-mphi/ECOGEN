/*
 * HISTORY:
 * This is the header of a CPP version of the LSODA library slightly modified by
 * Kevin Schmidmayer.
 * The original header version was aquired from
...
public:
    ...
    void lsoda_update(LSODA_ODE_SYSTEM_TYPE f, const size_t neq,
                      ...
                      double rtol = 1.e-6, double atol = 0. // Tolerance
                     );
