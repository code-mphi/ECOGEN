...
CellO2GhostCartesian::CellO2GhostCartesian() : CellO2Cartesian(), m_rankOfNeighborCPU(0), m_vecPhasesSlopesGhost(0), m_mixtureSlopesGhost(0), m_vecTransportsSlopesGhost(0) {}

//***********************************************************************

CellO2GhostCartesian::CellO2GhostCartesian(int lvl) : CellO2Cartesian(lvl), m_rankOfNeighborCPU(0), m_vecPhasesSlopesGhost(0), m_mixtureSlopesGhost(0), m_vecTransportsSlopesGhost(0) {}
...
int CellO2GhostCartesian::getRankOfNeighborCPU() const
{
...
void CellO2GhostCartesian::setRankOfNeighborCPU(int rank)
{
...
void CellO2GhostCartesian::computeLocalSlopes(CellInterface& cellInterfaceRef, Limiter& globalLimiter, Limiter& interfaceLimiter,
