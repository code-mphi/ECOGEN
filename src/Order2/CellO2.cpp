...
void CellO2::computeLocalSlopes(CellInterface& cellInterfaceRef, Limiter& globalLimiter, Limiter& interfaceLimiter,
...
void CellO2::computeLocalSlopesLimite(CellInterface& cellInterfaceRef, Limiter& globalLimiter, Limiter& interfaceLimiter,
...
void CellO2::predictionOrdre2(const double& dt, Symmetry* symmetry)
{
  ...
  model->relaxations(this, dt, vecPhasesO2);
